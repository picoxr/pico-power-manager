...
public class ShellCmd {
	public static void execute(String[] cmds, ICmdResultCallback callback) {
		List cmdArgs = Arrays.asList(cmds);
		execute(cmdArgs, callback);
	}

	public static void execute(String cmdLine, ICmdResultCallback callback) {
		List cmds = buildArgs(cmdLine);
		execute(cmds, callback);
	}

	public static void execute(List<String> cmdArgs, ICmdResultCallback callback) {
